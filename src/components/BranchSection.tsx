...
const BranchSection = () => {
  ...
  return (
    <section id="contact" className="pb-20 bg-muted/30">
      <div className="container max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
        ...
        {/* Right - Map */}
        <div className="w-full h-full min-h-[300px] sm:min-h-[400px] md:min-h-[520px] rounded-2xl overflow-hidden shadow-md border border-border/40">
          <iframe
