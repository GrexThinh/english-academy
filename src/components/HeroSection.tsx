      ...
      <div className="container mx-auto px-4 z-10 max-w-7xl">
        ...
        <div className="max-w-[920px] text-left">
          {/* <motion.p
            ...
            className="text-victoria-gold text-lg md:text-3xl font-semibold tracking-wide mb-3 md:mb-5 brightness-[1.2]"
          >
            {t("hero.subtitle")}
          </motion.p> */}
          ...
          <motion.div
            ...
            className="mt-8 md:mt-10 flex flex-col md:flex-row gap-5"
          >
            <Button
              size="lg"
              className="
                relative group overflow-hidden
                rounded-xl md:rounded-[30px_12px_30px_12px]
