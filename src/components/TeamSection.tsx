  ...
  const teachers = [
    {
      ...
      role: "IELTS 8.0",
      image: "/img/teacher/teacher-1.jpg",
    },
    {
      name: "Mr. Michael Brown",
      role: "IELTS 8.0",
      image: "/img/teacher/teacher-2.jpg",
    },
    {
      name: "Ms. Sarah Johnson",
      role: "IELTS 8.0",
      image: "/img/teacher/teacher-3.jpg",
    },
    {
      name: "Mr. David Wilson",
      role: "IELTS 8.0",
      image: "/img/teacher/teacher-4.jpg",
    },
  ];
            ...
            {teachers.map((teacher, idx) => (
              <CarouselItem key={idx} className="basis-full md:basis-1/3 px-4">
                <div key={idx} className="group relative">
                  <div className="relative rounded-3xl overflow-hidden border-4 border-victoria-red transition-all duration-300 h-[320px] md:h-[450px]">
                    <Image
                      src={teacher.image}
                      alt={teacher.name}
                      fill
